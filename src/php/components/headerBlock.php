...
<header>
    <div class='header-logo'>
        <a href="../pages/home.php"><i id="back-icon" class="material-symbols-outlined">arrow_back</i></a>
    </div>
    ...
    <div class='header-user'>
        <div title="Imagem do usuário" class='user-image'>
            <img class='user-img' src='../pages/uploads/user-img.jpg' alt='imagem do usuário'>
        </div>
        <div class='line'>
            <hr>
        </div>
